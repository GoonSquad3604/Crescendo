...
//Rotates robot until it faces the amp using AprilTags and the gyro
public class RotateToAmp extends ProfiledPIDCommand {
  ...
  public RotateToAmp(CommandSwerveDrivetrain drivetrain) {
    super(
