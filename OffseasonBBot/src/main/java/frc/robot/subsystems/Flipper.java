...
public class Flipper extends SubsystemBase {
  ...
  public Flipper() {
    ...
    flipperPIDController.setP(Constants.FlipperConstants.flipperP); // geometry dash
    flipperPIDController.setI(Constants.FlipperConstants.flipperI);
    flipperPIDController.setD(Constants.FlipperConstants.flipperD);
  ...
  public void runFlipper() {
    flipperMotor.set(Constants.FlipperConstants.runFlipperPower);
  }
...
//For when the note gets stuck on the robot's flipper
  public void panic() {
