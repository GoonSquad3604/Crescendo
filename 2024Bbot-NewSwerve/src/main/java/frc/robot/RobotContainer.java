...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    buttonBox.button(11).and(climberTrigger).onTrue(new InstantCommand(() -> s_Shooter.stopAngle(), s_Shooter));
    buttonBox.button(11).and(climberTrigger).onTrue(new InstantCommand(() -> s_Climber.lowerClimber()));
    buttonBox.button(11).onTrue(new InstantCommand(() -> s_Shooter.shooterTo()));
    buttonBox.button(12).onTrue(
