...
public class Flipper extends SubsystemBase {
  ...
  flipperPIDController.setP(1.2);
  flipperPIDController.setI(0);
  flipperPIDController.setD(0);

  flipperPIDController.setOutputRange(-.2, 1);
  ...
  public void setFlipperUp(){
    flipperPIDController.setReference(.72, ControlType.kPosition);
  }

  public void setFlipperDown(){
    flipperPIDController.setReference(.34, ControlType.kPosition);
  }
  ...
  public void periodic() {
    // This method will be called once per scheduler run
     ...
     double newFlipperP = SmartDashboard.getNumber("FlipperkP", 0);
